...
public class Scoreboard extends GPanel{
    ...
    public void initComponents() throws IOException, FontFormatException {
        ...
        JButton Back = new GButton("Back", 24f, 765, 650, 230, 63);
        JLabel label = new JLabel("Geometry Wars", SwingConstants.CENTER);
        GLabel Player = new GLabel("Player", 24, 235,160,169,62, false, Color.cyan);
        GLabel Score = new GLabel("Score", 24, 424,160,169,62, false, Color.cyan);
        GLabel HighScore = new GLabel("Highscore", 24, 613,160,169,62, false, Color.cyan);
